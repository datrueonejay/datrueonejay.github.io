    ...
    return (
      <div className="Dock">
        ...
        <DockApp
          ...
          link="https://github.com/datrueonejay"
        />
        <DockApp
          icon={
            this.props.os === OS.DROID
              ? require("../images/linkedIn.png")
              : require("../images/linkedInIOS.png")
          }
          link="https://www.linkedin.com/in/jayquelada/"
        />
        <DockApp
          icon={
            this.props.os === OS.DROID
              ? require("../images/resume.png")
              : require("../images/resumeIOS.png")
          }
          link={require("../assets/JaydenArqueladaResume.pdf")}
        />
        <DockApp
          icon={
            this.props.os === OS.DROID
              ? require("../images/contact.png")
              : require("../images/contactIOS.png")
          }
          link="mailto:jayarquelada@gmail.com"
          target="_top"
        />
      </div>
    );
